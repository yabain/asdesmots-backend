...
export default () => ({
    ...
    //Email template name
    EMAIL_TEMPLATE_NEW_REGISTRATION:"SMARTESTLOTTO_WELCOME_TEMPLATE",
    EMAIL_TEMPLATE_ACCOUNT_CONFIRMATION:"SMARTESTLOTTO_CONFIRM_EMAIL_TEMPLATE",
    EMAIL_TEMPLATE_RESET_PASSWORD:"SMARTESTLOTTO_RESET_PASSWORD_EMAIL_TEMPLATE",
    EMAIL_TEMPLATE_NEW_SUBSCRIPTION:"SMARTESTLOTTO_NEW_SUBSCRIPTION_EMAIL_TEMPLATE",
    EMAIL_TEMPLATE_REMIND_SUBSCRIPTION:"SMARTESTLOTTO_REMIND_SUBSCRIPTION_EMAIL_TEMPLATE",
    EMAIL_TEMPLATE_CANCELED_SUBSCRIPTION:"SMARTESTLOTTO_CANCELED_SUBSCRIPTION_EMAIL_TEMPLATE",
